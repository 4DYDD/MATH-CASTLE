...
const Classic = () => {
  ...
  const renderCell = (row: number, col: number) => {
    ...
    return (
      <div
        key={`${row}-${col}`}
        className={`aspect-square w-full border border-slate-600/60 cursor-pointer flex items-center justify-center text-base sm:text-lg font-semibold select-none
        bg-gradient-to-b from-[#1f1f1f] to-[#141414]
        hover:from-[#252525] hover:to-[#181818] hover:border-yellow-400/60 transition-all duration-150
  ...
  return (
    ...
    >
      <div onClick={clearSelection} className="w-full max-w-5xl mx-auto">
        {/* Header */}
        <div className="rounded-xl p-3 mb-5 border border-slate-700/60 bg-gradient-to-b from-[#1c1c1c] to-[#121212] shadow-[0_4px_12px_-2px_rgba(0,0,0,0.4)]">
          <div className="flexcc space-y-5">
            <div className="px-4 py-3 rounded-lg border w-full border-slate-600/70 bg-[#181818] flexc space-x-2">
              <div className="w-full">
                <div className="bg-red-500 rounded-xl size-[120px] flexcc !justify-end p-2.5">
                  Your Enemy!
                </div>
              </div>
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="rounded-xl p-4 border border-slate-700/60 bg-[#151515]">
              <div className="flex items-center gap-2 mb-3">
                <div className="px-2 py-1 rounded-md bg-[#222] border border-slate-600/70 text-[11px] tracking-wide text-slate-300 flex items-center gap-2">
              ...
              <div className="grid grid-cols-6 gap-[3px] sm:gap-1 max-w-md mx-auto select-none">
